...
train_data = "/home/byeonghak/data/KITTI/KITTI_train_lmdb"
test_data = "/home/byeonghak/data/KITTI/KITTI_val_lmdb"
resize_width = 600
resize_height = 150
...
save_dir = "models/SSD_v2/KITTI/inha/{}".format(job_name)
snapshot_dir = "models/SSD_v2/KITTI/inha/{}".format(job_name)
job_dir = "jobs/SSD_v2/KITTI/inha/{}".format(job_name)
...
pretrain_model = "models/ImageNet_inception_v2_8_preActRes_iter_100000.caffemodel"
